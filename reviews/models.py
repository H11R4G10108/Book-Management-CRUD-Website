...
class Book(models.Model):
     ...
     cover = models.ImageField(upload_to="book_covers/", verbose_name="The book's cover", null=True)
     sample = models.FileField(upload_to="book_samples/", verbose_name="Sample for the book", null=True)
